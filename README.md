...
- **Token economy** (C2 partial): 1 token per 500 personal `boss_damage` milestone. Three one-shot perks (ChampionBadge, ExtraSlot, SecondAutoPreset) with descriptions; gameplay perks are placeholder until their plumbing lands.
